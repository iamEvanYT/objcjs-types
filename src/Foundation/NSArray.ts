...
export declare class _NSArray extends _NSObject {
  ...
  differenceFromArray$withOptions$usingEquivalenceTest$(other: _NSArray, options: number, block: (...args: any[]) => any): NobjcObject;
  differenceFromArray$withOptions$(other: _NSArray, options: number): NobjcObject;
  differenceFromArray$(other: _NSArray): NobjcObject;
  arrayByApplyingDifference$(difference: NobjcObject): _NSArray | null;
