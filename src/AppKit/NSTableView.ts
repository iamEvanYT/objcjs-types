...
export declare class _NSTableView extends _NSControl {
  ...
  rowViewAtRow$makeIfNecessary$(row: number, makeIfNecessary: boolean): NobjcObject;
  ...
  didAddRowView$forRow$(rowView: NobjcObject, row: number): void;
  didRemoveRowView$forRow$(rowView: NobjcObject, row: number): void;
  ...
  headerView(): NobjcObject;
  setHeaderView$(value: NobjcObject): void;
