...
export declare class _NSCollectionView extends _NSView {
  ...
  // Instance methods
  reloadData(): void;
  layoutAttributesForItemAtIndexPath$(indexPath: _NSIndexPath): NobjcObject;
  layoutAttributesForSupplementaryElementOfKind$atIndexPath$(kind: number, indexPath: _NSIndexPath): NobjcObject;
